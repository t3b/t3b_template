...
module.exports = {
	deploy: {
		options: {
			...
			include: [(config.JavaScripts.requireJS.useAlmondOnBuild) ? config.JavaScripts.requireJS.almondSourceFile : config.JavaScripts.requireJS.requireJsSourceFile, config.JavaScripts.requireJS.config],
